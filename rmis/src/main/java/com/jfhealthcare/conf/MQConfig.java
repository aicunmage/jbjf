...
import com.jfhealthcare.common.alimq.MqConsumer4UploadFileListener;
...
public class MQConfig {
	...
	@Value("${file_upload_onsaddr}")
	private String fileUploadOnsaddr;
...
//	@Bean
	public Consumer createConsumer() {
		...
		consumer.subscribe(fileUploadOnsaddr,"*", mqConsumer4UploadFileListener);
//		consumer.start();
		log.info("*******consumer  开始完成。。。。。。。");
		return consumer;
	}
}

...
public class ApplyWorklistController {
    ...
    public BaseResponse updateApplyWorkListToView(@RequestBody ApplyWorklistRequest applyWorklistRequest, @LoginUser LoginUserEntity loginUserEntity) {
        try {
            //提交后 改变申请状态

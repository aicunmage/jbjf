...
public class SysDictScanmethodServiceImpl implements SysDictScanmethodService {
	...
	@Override
	public void deleteDictScanmethod(Integer id) {
	...
	public void updateDictScanmethod(SysDictScanmethodRequest sysDictScanmethodRequest) {
		...
		sysDictScanmethodMapper.updateByPrimaryKeySelective(sysDictScanmethod);
	...
	@Override
	public SysDictScanmethod queryDictScanmethodById(Integer id) {

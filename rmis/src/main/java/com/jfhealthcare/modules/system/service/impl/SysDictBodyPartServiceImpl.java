...
public class SysDictBodyPartServiceImpl implements SysDictBodypartService {
	...
	public PageInfo<SysDictBodypart> queryDictBodypart(SysDictBodypartRequest sysDictBodypartRequest) {
		...
		if(sysDictBodypartRequest.getId() != null){
			criteria.andEqualTo("id",sysDictBodypartRequest.getId());
		}
	...
	@Override
	public void deleteDictBodypart(Integer id) {
	...
	public void updateDictBodypart(SysDictBodypartRequest sysDictBodypartRequest) {
		...
		sysDictBodypartMapper.updateByPrimaryKeySelective(sysDictBodypart);
	}
	...
	@Override
	public SysDictBodypart queryDictBodypartById(Integer id) {

...
public class ViewWorklistResponse {
    ...
    private String accessionNumDcm;
     ...
     * 用于判断是否需要提醒字段
     */
    private Integer isRemindFlag;

    private Integer isTimeOutFlag; //判断是否超时标志，0--未超时；1--即将超时；2--已超时；

    private String rate; //报告评级

    private String suggest; //报告意见

    private String colour;//机构所属分类颜色

    private String classifyName;//机构所属分类名称
}